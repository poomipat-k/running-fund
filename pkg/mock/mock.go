...
type MockProjectStore struct {
	...
	AddProjectFunc                func(userId int, otherFiles []projects.DetailsFiles) (int, error)
...
func (m *MockProjectStore) AddProject(userId int, attachments []projects.DetailsFiles) (int, error) {
